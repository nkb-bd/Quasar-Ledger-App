...
/* harmony default export */ var MyLayoutvue_type_script_lang_js_ = ({
  ...
  computed: _objectSpread({}, Object(vuex_esm["d" /* mapState */])('LedgerStore', ['userDetails']), {
    todaysDate: function todaysDate() {
      var timeStamp = Date.now();
      return date["a" /* default */].formatDate(timeStamp, 'dddd, DD MMM YYYY hh:mm A');
    },
