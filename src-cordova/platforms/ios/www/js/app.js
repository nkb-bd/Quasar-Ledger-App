...
/******/ 				var href = "css/" + ({}[chunkId]||chunkId) + "." + {"2":"49a41486","3":"37fa8b69","4":"88c49b34","5":"33214587","6":"93c66a79","7":"31d6cfe0","8":"31d6cfe0","9":"31d6cfe0","10":"31d6cfe0","11":"31d6cfe0","12":"31d6cfe0"}[chunkId] + ".css";
...
/* harmony import */ var _boot_firebase__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("fc1b");
/* harmony import */ var quasar_src_utils_uid_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("1732");
...
var actions = {
  registerUser: function registerUser(_ref, payload) {
    ...
    _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseAuth */ "b"].createUserWithEmailAndPassword(payload.email, payload.password).then(function (response) {
      var userId = _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseAuth */ "b"].currentUser.uid;
      _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseDb */ "c"].ref('users/' + userId).set({
        name: payload.name,
        email: payload.email,
  ...
  loginUser: function loginUser(_ref2, payload) {
    _Users_nakib_Projects_quasar_quasar_todo_node_modules_babel_runtime_corejs2_helpers_objectDestructuringEmpty__WEBPACK_IMPORTED_MODULE_6___default()(_ref2);

    _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseAuth */ "b"].signInWithEmailAndPassword(payload.email, payload.password).then(function (response) {
      var userId = _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseAuth */ "b"].currentUser.uid;
    }).catch(function (error) {
      console.log(error.message);
    });
  ...
  logoutUser: function logoutUser() {
    _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseAuth */ "b"].signOut();
  },
  handleAuthChange: function handleAuthChange(_ref3) {
    ...
    var commit = _ref3.commit,
        ...
        state = _ref3.state;
    _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseAuth */ "b"].onAuthStateChanged(function (user) {
      if (user) {
        // User is logged in.
        var userId = _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseAuth */ "b"].currentUser.uid;
        _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseDb */ "c"].ref('users/' + userId).once('value', function (snapshot) {
  ...
  firebaseUpdateUser: function firebaseUpdateUser(_ref4, payload) {
    ...
    if (payload.userId) {
      _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseDb */ "c"].ref('users/' + payload.userId).update(payload.updates);
    }
  },
  firebaseGetUsers: function firebaseGetUsers(_ref5, payload) {
    var commit = _ref5.commit;
    _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseDb */ "c"].ref('users/').on('child_added', function (snapshot) {
      var userDetails = snapshot.val();
    ...
    _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseDb */ "c"].ref('users/').on('child_changed', function (snapshot) {
      var userDetails = snapshot.val();
      var userId = snapshot.key;
      commit('updateUser', {
        userId: userId,
  ...
  firebaseGetMessages: function firebaseGetMessages(_ref6, otherUserId) {
    ...
    messageRef = _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseDb */ "c"].ref('chats/' + userId + '/' + otherUserId);
  ...
  firebaseSendMessage: function firebaseSendMessage(_ref8, payload) {
    ...
    messageRef = _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseDb */ "c"].ref('chats/' + userId + '/' + payload.otherUserId).push(payload.message);
    payload.message.from = 'them';
    messageRef = _boot_firebase__WEBPACK_IMPORTED_MODULE_9__[/* firebaseDb */ "c"].ref('chats/' + payload.otherUserId + '/' + userId).push(payload.message);
    console.log(payload);
  },
  addBusiness: function addBusiness(_ref9, businessData) {
    var commit = _ref9.commit;
    var businessId = Object(quasar_src_utils_uid_js__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])();
    businessData.id = businessId;
    var payload = businessData;
    commit('addBusiness', payload);
  },
  addRecord: function addRecord(_ref10, recordData) {
    var commit = _ref10.commit;
    console.log('x');
    var rcordId = Object(quasar_src_utils_uid_js__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])();
...
var getters = {
  ...
  getBusinessList: function getBusinessList(state) {
