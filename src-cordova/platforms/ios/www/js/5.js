...
/* harmony default export */ var BusinessListvue_type_script_lang_js_ = ({
  ...
  computed: {
    businessList: function businessList() {
      return this.$store.getters['LedgerStore/getBusinessList'];
    }
  },
  components: {
