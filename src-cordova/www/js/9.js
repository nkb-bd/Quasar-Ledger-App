...
/* harmony default export */ var Authenticationvue_type_script_lang_js_ = ({
  ...
  methods: _objectSpread({}, Object(vuex_esm["b" /* mapActions */])('LedgerStore', ['registerUser', 'loginUser', 'clearErrorMessage']), {
    ...
    onSubmitLogin: function onSubmitLogin() {
      ...
      if (!this.$refs.password.hasError && !this.$refs.email.hasError) {
        ...
        if (this.formDataLogin.email != '') {
          var response = this.loginUser(this.formDataLogin);
        } // this.loading = false;
  ...
  computed: _objectSpread({}, Object(vuex_esm["c" /* mapGetters */])('LedgerStore', ['getErrors']))
});
...
runtime_auto_import_default()(component, 'components', {QPage: QPage["a" /* default */],QCard: QCard["a" /* default */],QTabs: QTabs["a" /* default */],QTab: QTab["a" /* default */],QSeparator: QSeparator["a" /* default */],QTabPanels: QTabPanels["a" /* default */],QTabPanel: QTabPanel["a" /* default */],QCardSection: QCardSection["a" /* default */],QInput: QInput["a" /* default */],QIcon: QIcon["a" /* default */],QBtn: QBtn["a" /* default */],QBanner: QBanner["a" /* default */]})
